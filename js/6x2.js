...
function verificar() {
    ...
    // Limpa o conteúdo da tabela antes de adicionar novos resultados
    resultado.innerHTML = "";
    let row = resultado.insertRow();
    let cell1 = row.insertCell(0);
    let cell2 = row.insertCell(1);

    if (nomesVazios.length > 0) {
        cell1.innerHTML = nomesVazios.join("<br>");
    } else {
        cell1.innerHTML = "Não há funcionários trabalhando na coluna do dia atual.";
    }
    if (nomesNaoVazios.length > 0) {
        cell2.innerHTML = nomesNaoVazios.join("<br>");
    } else {
        cell2.innerHTML = "Não há funcionários de folga na coluna do dia atual.";
    }
